...
Install the Kaspersky Add-on for Splunk
====================================
- Get the Kaspersky Add-on for Splunk by downloading it from `Splunkbase`_ or browsing to it using the app browser within Splunk Web.
...
.. _Splunkbase: https://splunkbase.splunk.com/app/4656/
